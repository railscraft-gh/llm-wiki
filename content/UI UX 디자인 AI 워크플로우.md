...
### Hazelcast 2인 팀 실무 협업 사례
- 디자이너 1명이 직접 HTML/CSS 코드로 프로토타입을 구성해 GitHub에 푸시.
- AI 에이전트가 이를 컴포넌트로 자동 변환하여 전달.
- 프론트엔드 엔지니어 1명은 단순 화면 조립에서 벗어나 시스템 아키텍처 및 복잡한 API 연동 등 순수 고난도 엔지니어링에만 집중.
