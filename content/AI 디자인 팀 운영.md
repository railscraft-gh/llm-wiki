...
- [[디자인 시스템]]은 component catalog보다 intent, block, primitive, review gate를 관리하는 쪽으로 이동한다.
...
- [[디자인 시스템]]의 계층을 Tokens -> Components -> Blocks -> Artifacts -> Threads 구조로 설계하여 AI가 거버넌스 룰에 맞춰 자동 조립하게 제어. [출처: 디자인 팀이 만드는 방식을 다시 짜기]
...
## 충돌
- 전통적 [[디자인 시스템]]의 픽셀 단위 일관성과는 일부 충돌할 수 있다. 대신 intent와 review gate를 통해 진화하는 일관성을 얻는다.
