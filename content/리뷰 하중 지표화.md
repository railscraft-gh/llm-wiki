...
## 한 줄 정의
AI [[코딩 에이전트]] 도입으로 급증한 코드 리뷰 요청을 정량화하고 모니터링하여, 특정 시니어 개발자에게 편중되는 인지적 부하(Review Load)를 분산하고 제어하는 관리 [[워크플로]]우이다.

## 핵심 요지
* **[[인지적 비용]]의 정량화**: 단순 PR 개수가 아닌, 코드 변경 줄 수(LOC) 및 파일 영향도, 비즈니스 영향도를 고려하여 리뷰 하중을 측정한다 (raw/My Best Senior Engineer Quit Last Month. Her Exit Interview Was Scheduled for Forty Minutes. The Last Five Changed How I Run My Team..md).
