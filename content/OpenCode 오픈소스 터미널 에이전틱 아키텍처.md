...
## 한 줄 정의
Cloud Code나 [[Cursor]]의 대안으로, 100% 오픈소스 기반 터미널 환경에서 스킬(Skills), 메모리 파일(`agents.md`), Plan/Bold 모드 이원화, 서브에이전트 병렬 위임 및 Playwright MCP 서버를 융합한 에이전틱 코딩 툴킷이다.
...
- **계획 영속화 [[워크플로]]우**: Plan 모드에서 아키텍처 질문에 답변하여 완성된 계획을 `.agents/plans/`에 파일로 저장한 다음, `/new`로 컨텍스트 노이즈를 완전 제거하고 새 세션에서 코딩 시작.
...
## 출처
- [[OpenCode]] 연동 및 무료/유료 프로바이더: [raw/opencode-masterclass-summary.md#L34-L63](file:///Users/railscraft/[[Obsidian]]/raw/opencode-masterclass-summary.md#L34-L63)
- `agents.md` 규칙 및 Bold 모드 서브에이전트 필수화: [raw/opencode-masterclass-summary.md#L98-L123](file:///Users/railscraft/[[Obsidian]]/raw/opencode-masterclass-summary.md#L98-L123)
- Plan/Bold 모드 전환 및 세션 영속화: [raw/opencode-masterclass-summary.md#L139-L172](file:///Users/railscraft/[[Obsidian]]/raw/opencode-masterclass-summary.md#L139-L172)
- Playwright MCP 서버 연결 및 e2e 테스트: [raw/opencode-masterclass-summary.md#L174-L190](file:///Users/railscraft/[[Obsidian]]/raw/opencode-masterclass-summary.md#L174-L190)
