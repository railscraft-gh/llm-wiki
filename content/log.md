...
- 생성: [[연구 파트너 (Research Partner)]], [[역발상 오해 검증]], [[회의주의자의 시선 (The skeptic's pass)]], [[핵심 전제 분석(Load-bearing assumption)]], [[그래서 어쩌라고 필터 (The so what filter)]], [[교차 분석 (Cross-analysis)]], [[확증 편향 탈피 검증 (The what would change my mind prompt)]]
