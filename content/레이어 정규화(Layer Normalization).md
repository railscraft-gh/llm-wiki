...
- **[[트랜스포머]]의 필수 구성요소**: [[트랜스포머 아키텍처]] 내의 멀티 헤드 어텐션(Multi-Head Attention)과 피드포워드(Feed-Forward) 신경망 블록의 출력단 혹은 입력단에 배치되어 데이터의 수치적 안정성을 묵묵히 지탱한다.
