...
## 한 줄 정의
Andrej Karpathy가 제안한 PKM(개인 지식 관리) 패러다임으로, 사람이 노트를 작성하고 연결하던 기존 방식에서 벗어나, raw 원천 자료 수집과 질문만을 담당하고 지식의 요약·연결·컴파일·위키 생성 및 유지보수는 [[LLM]]이 수행하는 AI 중심 지식 관리 시스템이다.
