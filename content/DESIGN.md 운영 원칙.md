...
## 한 줄 정의
Anthropic 엔지니어 2인이 작성한 30줄짜리 마크다운 사양이 [[AI Slop]] 미학을 저지하며 4개월 만에 277,000+ 설치를 달성해, 대규모 PDF [[디자인 시스템]]을 대체하고 [[LLM]] 취향을 직접 구속하는 기계 읽기 가능한 디자인 선언문 아키텍처.
...
## 예시
- **`DESIGN.md` 배포**: 사내 코드 저장소에 30줄 분량의 [[DESIGN.md]]를 포함시켜 [[Claude Code]]나 [[Cursor]]가 프론트엔드 컴포넌트를 빌드할 때 Inter 폰트 사용을 원천 금지하고 브루탈리스트/에디토리얼 톤을 강제 적용.
