...
[[디자인 시스템]]과 Figma 컴포넌트 설계 같은 장인정신은 여전히 중요하지만, 디자이너들이 진정 무거운 결정(제품 전략, 비즈니스 성과 지표)을 외면하는 도피처로 쓰여왔다.
...
### [[디자인 시스템]] 피벗 실패 사례
어느 디자인 디렉터가 6개월 동안 공들여 50페이지 분량의 정교한 [[디자인 시스템]]을 구축했음에도, 회사가 비즈니스 모델을 전면 피벗하자마자 시스템의 40페이지가 단 일주일 만에 무용지물이 되는 현상이 발생한다. 이는 디자이너가 비즈니스와 밀착하지 못한 채 엉뚱한 문제를 정교하게 풀었기 때문이며, 전략적 밀착 없는 단순 화려한 화면은 '예쁜 낭비(beautiful waste)'에 불과함을 극명하게 드러낸다.
...
## 출처
- doc.cc에 게재된 Roger Wong의 크래프트 위기 분석 (주니어 채용 및 IDEO 매출 지표)
- WebAIM의 2024년 100만 웹사이트 분석 (접근성 81% 저대비 텍스트 수치)
- Quarter Inch Hole에 소개된 Lawton Pybus의 해고 영향 연구
- 2023년-2024년 디자인 산업 공식 미디어 보도 (CDO 임명 건수)
