...
Loop는 이 운영의 중심이다. cron 스케줄로 에이전트를 반복 실행하는 기능으로, [[Ralph Loop]]의 self-referential 루프와는 다른 개념이다. [[Ralph Loop]]가 한 작업을 완료할 때까지 자기 자신을 호출하는 반면, Boris의 Loop는 일정 주기로 독립적 에이전트 작업을 트리거한다.
