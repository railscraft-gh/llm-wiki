...
- **[[하네스 엔지니어링]]의 기초**: GPT-3.5에 [[에이전틱 [[워크플로]]우]]를 씌우면 GPT-4 제로샷 성능을 상회한다는 발견을 시작으로, 모델 외부의 반복(Iteration) 및 [[검증 루프]]가 성능을 끌어올리는 주축이 되었다.
...
- evolution-of-ai-agentic-patterns
- raw/2026년 AI 에이전트 [[워크플로]]우 핵심 패턴 분석.md
