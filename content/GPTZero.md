...
- **상대적 안정성**: [[ZeroGPT]]와 비교 테스트 시 비교적 더 합리적이고 정상적인 판단 결과를 출력하는 모습을 보여주지만, 이 역시 100% 완전무결하지는 않다.
...
## 예시
- **미국 독립선언서 분석 비교**:
  - [[ZeroGPT]]가 92.5%의 극단적 오판을 할 때, GPTZero는 동일 텍스트에 대해 **AI 점수 2%**를 도출하여 역사적 사실에 부합하는 안정적 탐지 성공에 가까운 결과를 보여주었다.
