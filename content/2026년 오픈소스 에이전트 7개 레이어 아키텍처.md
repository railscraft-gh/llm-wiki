...
7. **Layer 7: Models & Inference**: v[[LLM]] (PagedAttention, 프로덕션 표준), [[Ollama]] (로컬), llama.cpp (C++ CPU/Apple Silicon), SGLang (JSON 스키마 엔진 내장 강제).
...
## 충돌
- **Latency-first vs Audit-first 스택 충돌**: 지연 시간 최적화 스택은 Mem0 + v[[LLM]]으로 수렴하는 반면, 감사/규제 준수 우선 스택은 [[LangGraph]] + Langfuse 조합으로 이동한다. 한 에코시스템으로 두 제약을 동시 충족할 수 없다.
...
## 출처
- 7개 레이어 툴킷 개요 및 제약 조건: [raw/The Open-Source Agent Toolkit in 2026-ko.md#L19-L30](file:///Users/railscraft/[[Obsidian]]/raw/The%20Open-Source%20Agent%20Toolkit%20in%202026-ko.md#L19-L30)
- Layer 1 Orchestration & Layer 2 Memory 수치: [raw/The Open-Source Agent Toolkit in 2026-ko.md#L31-L58](file:///Users/railscraft/[[Obsidian]]/raw/The%20Open-Source%20Agent%20Toolkit%20in%202026-ko.md#L31-L58)
- Layer 4 Browser & Layer 5 Coding Agent 수치: [raw/The Open-Source Agent Toolkit in 2026-ko.md#L69-L91](file:///Users/railscraft/[[Obsidian]]/raw/The%20Open-Source%20Agent%20Toolkit%20in%202026-ko.md#L69-L91)
- Layer 6 Observability & Layer 7 Inference: [raw/The Open-Source Agent Toolkit in 2026-ko.md#L93-L130](file:///Users/railscraft/[[Obsidian]]/raw/The%20Open-Source%20Agent%20Toolkit%20in%202026-ko.md#L93-L130)
