...
3. **외부 [[세계 모델]]의 활용**: 뇌 내부에 완전한 [[세계 모델]]을 구성하여 실시간 변화를 모두 연산할 필요 없이, 외부 세계 자체를 가장 완벽한 '외부 표현(external representation)'으로 삼아 상호작용한다. (raw/What Makes Us Human.md)
...
- [[세계 모델]]: 인공지능이 환경의 시공간적 인과 관계를 예측하기 위해 생성하는 구조. 감각 운동적 수반성은 [[세계 모델]]이 굳이 가상 표상으로 무겁게 내장되지 않고 외부 세계 그 자체를 모델로 삼는 고유의 효율성을 강조한다. (raw/What Makes Us Human.md)
