...
| :--- | :--- | :--- |
| **Claude Code** | `/goal`, `/loop`, `/batch`, `/background` | Haiku 기반 경량 검증기 사용. `/batch`로 최대 30개 서브에이전트 병렬 확장, `/loop`로 최대 7일 자동화 예약 지원 [raw/How Claude Code, Codex, and Cursor Do Loop Engineering.md#L45](file:///Users/railscraft/Obsidian/raw/How%20Claude%20Code,%20Codex,%20and%20Cursor%20Do%20Loop%20Engineering.md#L45). |
