...
- **개발 환경(IDE/에이전트) 연동 및 한계**:
  ...
  - **[[Cline]]**: VS Code의 대표적인 오픈소스 [[코딩 에이전트]]로, 공급자 설정을 `OpenAI Compatible`로 맞춘 뒤 NVIDIA의 엔드포인트와 `nvapi-` 키를 주입하면, 파일 생성, 코드 수정, 터미널 실행, 버그 트래깅 등 전체 자율 루프(Agentic Loop)의 추론 서버로 NVIDIA Build 모델을 완벽하게 활용할 수 있다. [raw/Stop Paying $20_month. Use NVIDIA Build. 80+ Free AI Models.md#L109](file:///Users/railscraft/[[Obsidian]]/raw/Stop%20Paying%20$20_month.%20Use%20NVIDIA%20Build.%2080+%20Free%20AI%20Models.md#L109)
- **도구 사용(Tool Use / Function Calling) 및 특정 모델 한계점**:
  - **도구 사용 기능의 필수성**: 에이전트의 [[워크플로]]우 제어(파일 읽기/쓰기, 명령어 실행 등)를 위해서는 모델이 함수 호출(Function Calling)을 올바르게 수행해야 한다. 카탈로그 내 모든 모델이 이 기능을 온전히 지원하지는 않으므로 모델 카드를 반드시 확인해야 한다.
  - **openai/gpt-oss-20b**: 20억 파라미터급 오픈소스 모델로, 실전 테스트에서 [[Cline]]과의 결합 시 꽤 훌륭하게 작동하는 준수한 성능을 보여주었다. [raw/Stop Paying $20_month. Use NVIDIA Build. 80+ Free AI Models.md#L140](file:///Users/railscraft/[[Obsidian]]/raw/Stop%20Paying%20$20_month.%20Use%20NVIDIA%20Build.%2080+%20Free%20AI%20Models.md#L140)
...
## 출처
- [Stop Paying $20_month. Use NVIDIA Build. 80+ Free AI Models](file:///Users/railscraft/[[Obsidian]]/raw/Stop%20Paying%20$20_month.%20Use%20NVIDIA%20Build.%2080+%20Free%20AI%20Models.md)
- [Stop Paying $20month. Use NVIDIA Build. 80+ Free AI Models](file:///Users/railscraft/[[Obsidian]]/raw/Stop%20Paying%20$20month.%20Use%20NVIDIA%20Build.%2080+%20Free%20AI%20Models.md)
