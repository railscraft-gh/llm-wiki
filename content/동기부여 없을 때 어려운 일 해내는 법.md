...
### 3. 자제력 유지를 방해하는 꼼수 경계
성공을 좇는 대다수 사람들이 시도하는 2분 규칙이나 보상 시스템 등의 꼼수(hacks)는 신선함이 떨어지는 수일 이내에 원래의 루틴으로 회귀하게 만든다. 지속적인 변화는 '어떻게(how)' 행동할지의 꼼수가 아니라, '왜(why)' 일하는지에 대한 거대한 이유(Big Why)를 뇌에 각인시키는 전전두엽 자제력 작동 원리에 기초한다.
