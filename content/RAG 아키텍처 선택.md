...
의미론적 유사도 기반의 시맨틱 벡터 검색과 키워드 매칭([[BM25]])을 결합한 [[하이브리드 검색]]이 기본 골격을 이루며, 엔티티 간 관계망 분석이 필수적인 도메인(법률, 의학, 금융 연쇄 구조)에서는 [[GraphRAG]]를 채택하여 설명 가능성(Explainability)을 확보합니다.
