...
## 상세
[raw/cc101_axwith_ko.md#L282](file:///Users/railscraft/[[Obsidian]]/raw/cc101_axwith_ko.md)에서 설명하듯, 바이브코딩은 안드레이 카파시가 명명한 개념으로, 명확한 요구사항 전달 능력이 프로그래밍 지식보다 더 중요하다. [[Claude Code]]는 단순히 대화만 하는 웹 UI와 달리 내 컴퓨터 폴더에 접근하여 수십 개의 파일을 동시에 처리하고 결과물을 저장한다.
