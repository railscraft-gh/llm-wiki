...
Sequoia Ascent 2026에서 카파시는 이를 더 명확히 했다. LLM은 생물학적 충동, 신체화된 생존 압력, 호기심, 놀이, 동물적 의미의 내재적 동기가 없다. 사전훈련, 사후훈련, RL, 제품 피드백, 경제적 인센티브에 의해 형성된 **인간 산출물의 통계적 시뮬레이션**이다. 의인화된 기대가 오도하기 때문에, 올바른 자세는 무시도 맹목적 신뢰도 아닌 경험적 친숙함이다. 출처: `raw/sequoia-ascent-2026-karpathy-ko.md`
